      ...
      <div className="footer-container">
        ...
        <div className="mt-4 text-center copyright">
          <p>
            ...
            Website Using HTML5 and CSS3" by Jonas Schmedtmann. No copyrights
            here. This webpage is for you! So go and do whatever you want with
            it and have fun.
          </p>
          <p>
            Rebuilt the project using React, React Bootstrap, React Scroll and React Spring instead of
            vanilla HTML5, CSS3 and jQuery.
          </p>
        </div>
      </div>
    </footer>
